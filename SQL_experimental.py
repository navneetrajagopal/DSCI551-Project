# -*- coding: utf-8 -*-
"""SQL_experimental.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_EI2gHc--Kqi3irJkf6HM_69YZjrWOa6

Please note this is an experimental version and has not been tested to the exact same extent
...
#inserts tool - limits the insert to only 1
...
#update tool - updates a single row
...
#delete tool - allows a single row delete
